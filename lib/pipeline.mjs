...
import { splitSentences } from './text-cleaner.mjs';
...
export async function run(extract) {
  ...
  if (config.streaming && engine.speakStream) {
    const stream = engine.speakStream({ voice: config.voice, speed: config.speed });
